...
AUTH_USER_MODEL = "user.CustomStarterUser"

WAGTAILMEDIA = {
    "MEDIA_MODEL": "core.CustomStarterMedia",  # string, dotted-notation. Defaults to "wagtailmedia.Media"
